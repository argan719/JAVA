...
public class Register {
   ...
   public static String searchUser(String search_name, String search_birth, BufferedReader inputStream) throws IOException {   
	 String str;
	 String name;
	 String birth;
	 ...
	 {
		 int idx = str.indexOf(" ");  
		 int idx2 = str.indexOf(" " , str.indexOf(" ") + 1);

		 name = str.substring(0,idx);
		 birth = str.substring(idx+1 , idx2);
		 if(name.equals(search_name) && birth.equals(search_birth)) return str;
	 }
	 return null;
   ...
   public static void register () throws IOException {
      ...
      for(;;)
      {
         ...
         outputStream.print(person.getbirth() + " ");
         try {
        	 inputStream = new BufferedReader(new FileReader("Person.txt"));
         }
         catch(FileNotFoundException e)
         {
       	  System.exit(0);
         ...
         /* 고객이 이미 등록되어있는 경우 */
         String str;
         if((str = searchUser(name, birth, inputStream))!=null) {
        	 String info[] = str.split(" ");
        	 System.out.println("이미 등록하신 고객입니다.\n");

        	 System.out.println("고객님의 가입 정보입니다.\n");
        	 System.out.println("이름 : " + info[0]);
        	 System.out.println("생년웡일 : " + info[1]);
        	 System.out.println("이용중인 보험상품 : " + info[2]);
        	 System.out.println("나이 : " + info[3]);
        	 if(info[4] == "true") System.out.println("사고유무 : 있음");
        	 else System.out.println("사고유무 : 없음");
        	 System.out.println("보험금 납입 시작 날짜 : " + info[5]);
        	 System.out.println("보험금 월 납입액 : " + info[6]);
        	 break Loop1;
         }
            ...
            if(want.equals("네")) {
               ...
               outputStream.print(productName + " ");
